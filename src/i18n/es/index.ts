...
const es: BaseTranslation = {
  ...
  home: {
    ...
    headerTwo: 'Puedo asistir con:',
    footer: 'Experto en soluciones web & móvil.',
  ...
  meta: {
    title: 'Desarrollo independiente de sitios web y aplicaciones.',
    description:
      'Desarrollador web y móvil con más de 10 años de experiencia profesional, especializado en la arquitectura de aplicaciones, desarrollo front-end, y colaboración en equipos técnicos. Experto en crear sitios web modernos, aplicaciones móviles híbridas, plataformas de e-commerce y añadir nuevas funcionalidades a sitios web existentes. Amplia experiencia en gestión de servicios en la nube y soluciones de comercio electrónico utilizando CMS como Contentful, Prismic y Shopify. Con un enfoque en el rendimiento, escalabilidad y mejores prácticas, he trabajado en proyectos exitosos para Adnami, Meaty, Iberia, GORM x Envision, y más.',
  },
  roles: {
    architect: {
